...
class PLoader implements PluginLoader{
	...
	public function loadPlugin($file){
		if(is_dir($file) and file_exists($file . "/core.yml") and file_exists($file . "/src/")){
	...
	public function getPluginDescription($file){
		if(is_dir($file) and file_exists($file . "/core.yml")){
			$yaml = @file_get_contents($file . "/core.yml");
			if($yaml != ""){
